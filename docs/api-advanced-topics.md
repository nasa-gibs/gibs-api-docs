...
Visualizations of scientific parameters (See [Visualization Categories](../visualization-layers/#visualization-categories)) are generated by mapping data values, or value ranges, to specific RGB values.  These scientific parameters represent data from one of the following categories:
...
The GIBS Colormap specification guides the creation of GIBS Colormap XML documents that comply with an ([XML Schema](https://gibs.earthdata.nasa.gov/schemas/ColorMap_v1.3.xsd)).  Each XML document contains the information required to map data values and RGB colors in a raster visualization.  The necessary information required to generate a legend graphic representation of the mapping is also provided.  See below for the fields included in each of these content area's entries.
...
| ------- | ------------- | ----------- | --------------- |
|   PNG   |   Horizontal  | [link](https://gibs.earthdata.nasa.gov/legends/AMSR2_Wind_Speed_Day_H.png) | ![PNG Horizontal](img/AMSR2_Wind_Speed_Day_H.png) |
|   SVG   |   Horizontal  | [link](https://gibs.earthdata.nasa.gov/legends/AMSR2_Wind_Speed_Day_H.svg) | ![SVG Horizontal](img/AMSR2_Wind_Speed_Day_H.svg) |
|   SVG   |   Vertical    | [link](https://gibs.earthdata.nasa.gov/legends/AMSR2_Wind_Speed_Day_V.svg) | ![SVG Vertical](img/AMSR2_Wind_Speed_Day_V.svg) |
...
* REST Tile - [https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/VIIRS_NOAA20_Thermal_Anomalies_375m_All/default/2020-10-01/500m/4/3/4.mvt](https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/VIIRS_NOAA20_Thermal_Anomalies_375m_All/default/2020-10-01/500m/4/3/4.mvt)
